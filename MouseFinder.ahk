; Not from JohnHimics.com, can't remember where it came from
; Script shows a tooltip in the corner of the screen
;   that shows the location of the mouse in coordinates
...
;if !GetKeyState("scrolllock","T") ; whether scrolllock is on or off
{
